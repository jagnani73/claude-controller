    ...
    return (
      <div className="flex h-dvh flex-col bg-neutral-950 text-white">
        ...
        <div className="min-h-0 flex-1">
          <MessageStream sessionId={activeSessionId} />
        </div>
  ...
  return (
    <div className="flex h-dvh flex-col bg-neutral-950 text-white">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <SessionList sessions={sessions} onSelect={subscribe} onStop={stopSession} />
        <div className="border-t border-neutral-800">
          <div className="px-4 pt-4 text-xs font-medium uppercase tracking-wider text-neutral-600">
            New Session
          </div>
          <CreateSessionForm workDir={workDir} onSubmit={createSession} />
        </div>
      </div>
    </div>
  );
